...
res.get("/todo",async(req,res) => {
    
    res.render("todo/task", {todos: datas }) //rendering the get-todo.ejs file and passing the todos data to it
})
res.render("todo/task",(req,res) => {
